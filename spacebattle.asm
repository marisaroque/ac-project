...
desenha_tudo:
				...
				MOV R2, redesenha_energia		; n�o mostra energia, se a flag estiver a 0. Para n�o piscar
				MOV R1, [R2]
				CMP R1, 0
				JEQ dt_screen
				CALL mostra_energia	
				
				MOV R1, 0						; j� desenhou, limpa flag
				MOV [R2], R1
				
				
dt_screen:		MOV R2, redesenha				; n�o desenha, se a flag estiver a 0. Para n�o piscar
				MOV R1, [R2]
				CMP R1, 0
				JEQ dt_fim
				
				MOV R0, estado_jogo				; n�o desenha, se terminado
				MOV R1, [R0]
				CMP R1, TERMINADO
...
dt_if_fim:    	MOV R1, 0						; j� desenhou, limpa flag
				MOV [R2], R1
